<template>
    <div class="page" style="color: white;">
        <div style="display: flex; justify-content: flex-start; margin-bottom: 20px;">
            <v-btn @click="$router.push('/addform');" style="border-radius: 7px;">Добавить формулу</v-btn>
            <v-btn href="https://t.me/monitoring_cluster_bot" target="_blank" style="border-radius: 7px; margin-left: 1%;">Перейти к боту</v-btn>
        </div>
